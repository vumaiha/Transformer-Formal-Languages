...
def build_parser():
	...
	parser.add_argument('-pos_encode_type', type = str, default = 'absolute', choices = ['absolute', 'cosine_npi','learnable','period_n'])
	parser.add_argument('-periodicity', type = int, default = 3, help='Periodicity for period_n positional encoding')
